...
const setCarrito = objeto =>{
 //  console.log(objeto)
    //console.log(objeto.querySelector('h5').textContent)
    const producto = {
...
function delay(i) {
    setTimeout(function() {
        //add task 
        var contador = String(i);
        arrayElement.push(i);
        console.log(`contando numeros: ${i+1}`)
        crearelemt(arrayElement);
...
const crearelemt=  async function () {
await arrayElement.forEach(item => {
